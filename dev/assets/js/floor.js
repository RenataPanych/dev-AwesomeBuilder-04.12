   ...
   const installFloor = () => {
        ...
        const renderInfo =(array)=> {
            const flatInformation = array.map(item =>{
                return (`
                    ...
                    <div class="info-item">
                        <div class="info-item__title">Площа квартири:</div>
                        <div>${item.square}</div>
                    </div>
                    <div class="info-item">
        ...
        flats.forEach(flat => {
            if (flat.classList.contains('booking')) {
                ...
                flat.querySelector('.status-cell__text-span').innerHTML = "Акція"
            } else if (flat.classList.contains('sold')) {
                flat.querySelector('.status-cell__text-span').innerHTML = "Продано"
            } else {
                flat.querySelector('.status-cell__text-span').innerHTML = "Вільна"
            }
